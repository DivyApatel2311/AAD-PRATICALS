...
def index():
    if request.method == 'POST':
        ...
        items, fractions, total_profit = fractional_knapsack(profits, weights, max_weight)
        
        return render_template('index.html', items=items, fractions=fractions, total_profit=total_profit)
