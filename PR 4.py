...
employees = [
    Employee(1, "Dhruvil", 45, 90000, "Manager", "9876543210"),
    Employee(2, "Nachiket", 25, 50000, "Developer", "9876543211"),
    Employee(3, "Deepak", 22, 30000, "Intern", "9876543212"),
    Employee(4, "Pratham", 60, 150000, "CEO", "9876543213"),
    Employee(5, "Divya", 35, 70000, "Designer", "9876543214"),
]
